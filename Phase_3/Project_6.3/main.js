...
//     if (book.isRead == "no") {
//             console.log(`Book ${book.title} is unread`);
//         }
    
// });

//better option 
const unreadBookTitles = bookList
.filter(book => book.isRead == "no")
.map(book => book.title);
unreadBookTitles.forEach(title => {
    console.log(`Book ${title} is unread`);
});
